...
Execute unit tests
```
    cd "SkillAssessor.Clouds.CognitoSyncLambda/test/SkillAssessor.Clouds.CognitoSyncLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "SkillAssessor.Clouds.CognitoSyncLambda/src/SkillAssessor.Clouds.CognitoSyncLambda"
